...
Blockly.utils.Coordinate.equals = function(a, b) { return a == b ? true : a && b ? a.x == b.x && a.y == b.y : !1 };
...
Blockly.utils.string.wrapLine_ = function(a, b) {
    ...
    do {
        ...
        var h = c.length / e,
            k = 1;
        for (d = 0; d < c.length - 1; d++) k < (d + 1.5) / h ? (k++, a[d] = true) : a[d] = !1;
...
Blockly.utils.string.wrapScore_ = function(a, b, c) {
    for (var d = [0], e = [], f = 0; f < a.length; f++) d[d.length - 1] += a[f].length, true === b[f] ? (d.push(0), e.push(a[f].charAt(a[f].length - 1))) : !1 === b[f] && d[d.length - 1]++;
...
Blockly.utils.Size.equals = function(a, b) { return a == b ? true : a && b ? a.width == b.width && a.height == b.height : !1 };
Blockly.utils.style = {};
...
Blockly.utils.isRightButton = function(a) { return a.ctrlKey && Blockly.utils.userAgent.MAC ? true : 2 == a.button };
...
Blockly.utils.tokenizeInterpolation = function(a) { return Blockly.utils.tokenizeInterpolation_(a, true) };
...
Blockly.utils.checkMessageReferences = function(a) {
    for (var b = true, c = Blockly.Msg, d = a.match(/%{BKY_[A-Z]\w*}/ig), e = 0; e < d.length; e++) {
...
Blockly.Events.fireNow_ = function() {
    for (var a = Blockly.Events.filter(Blockly.Events.FIRE_QUEUE_, true), b = Blockly.Events.FIRE_QUEUE_.length = 0, c; c = a[b]; b++)
        if (c.workspaceId) {
...
Blockly.Events.disableOrphans = function(a) {
    if ((a.type == Blockly.Events.MOVE || a.type == Blockly.Events.CREATE) && a.workspaceId) {
        ...
        if (a = b.getBlockById(a.blockId)) {
            var c = a.getParent();
            if (c && c.isEnabled())
                for (b = a.getDescendants(!1), a = 0; c = b[a]; a++) c.setEnabled(true);
...
Blockly.Component.prototype.dispose = function() { this.disposed_ || (this.disposed_ = true, this.disposeInternal()) };
...
Blockly.DropDownDiv.showPositionedByField = function(a, b, c) { Blockly.DropDownDiv.positionToField_ = true; return Blockly.DropDownDiv.showPositionedByRect_(Blockly.DropDownDiv.getScaledBboxOfField_(a), a, b, c) };
...
Blockly.DropDownDiv.hideIfOwner = function(a, b) { return Blockly.DropDownDiv.owner_ === a ? (b ? Blockly.DropDownDiv.hideWithoutAnimation() : Blockly.DropDownDiv.hide(), true) : !1 };
...
Blockly.Xml.blockToDom = function(a, b) {
    ...
    a.isEnabled() || c.setAttribute("disabled", true);
...
Blockly.Xml.cloneShadow_ = function(a, b) {
    for (var c = a = a.cloneNode(true), d; c;)
...
Blockly.Xml.domToWorkspace = function(a, b) {
    ...
    e || Blockly.Events.setGroup(true);
...
Blockly.Xml.domToBlock = function(a, b) {
    ...
    try {
        ...
        if (b.rendered) {
            ...
            setTimeout(function() { d.disposed || d.setConnectionTracking(true) }, 1);
            d.updateDisabled();
            b.resizeContents()
        } else
            for (f =
            ...
            switch (g.nodeName.toLowerCase()) {
                ...
                case "comment":
                    ...
                    h && c.getCommentIcon && !c.isInFlyout &&
                        setTimeout(function() { c.getCommentIcon().setVisible(true) }, 1);
                    break;
                case "data":
...
Blockly.Options = function(a) {
    ...
    var t = void 0 === a.oneBasedIndex ? true : !!a.oneBasedIndex,
...
Blockly.Options.parseMoveOptions = function(a, b) {
    ...
    d.drag = d.scrollbars ? void 0 === c.drag ? true : !!c.drag : !1;
    return d
};
...
Blockly.ScrollbarPair = function(a) {
    this.workspace_ = a;
    this.hScroll = new Blockly.Scrollbar(a, true, true, "blocklyMainWorkspaceScrollbar");
    this.vScroll = new Blockly.Scrollbar(a, !1, true, "blocklyMainWorkspaceScrollbar");
...
Blockly.ScrollbarPair.prototype.resize = function() {
    ...
    if (a) {
        var b = !1,
            c = !1;
        this.oldHostMetrics_ && this.oldHostMetrics_.viewWidth == a.viewWidth && this.oldHostMetrics_.viewHeight == a.viewHeight && this.oldHostMetrics_.absoluteTop == a.absoluteTop && this.oldHostMetrics_.absoluteLeft == a.absoluteLeft ? (this.oldHostMetrics_ && this.oldHostMetrics_.contentWidth == a.contentWidth && this.oldHostMetrics_.viewLeft == a.viewLeft && this.oldHostMetrics_.contentLeft == a.contentLeft || (b = true), this.oldHostMetrics_ &&
            this.oldHostMetrics_.contentHeight == a.contentHeight && this.oldHostMetrics_.viewTop == a.viewTop && this.oldHostMetrics_.contentTop == a.contentTop || (c = true)) : c = b = true;
...
Blockly.ASTNode.prototype.navigateBetweenStacks_ = function(a) {
    ...
    b = c.workspace.getTopBlocks(true);
...
Blockly.ASTNode.prototype.in = function() {
    switch (this.type_) {
        case Blockly.ASTNode.types.WORKSPACE:
            var a = this.location_.getTopBlocks(true);
...
Blockly.Connection.prototype.canConnectToPrevious_ = function(a) {
    ...
    if (!a.targetConnection) return true;
    a = a.targetBlock();
...
Blockly.Connection.prototype.isConnectionAllowed = function(a) {
    ...
    return -1 != Blockly.draggingConnections.indexOf(a) ? !1 : true
};
...
Blockly.Connection.prototype.connect = function(a) {
    if (this.targetConnection != a) {
        ...
        b || Blockly.Events.setGroup(true);
...
Blockly.Connection.prototype.disconnect = function() {
    ...
    d || Blockly.Events.setGroup(true);
...
Blockly.Connection.prototype.checkType = function(a) {
    if (!this.check_ || !a.check_) return true;
    for (var b = 0; b < this.check_.length; b++)
        if (-1 != a.check_.indexOf(this.check_[b])) return true;
    return !1
};
...
Blockly.Extensions.checkMutatorDialog_ = function(a, b) {
    ...
    if (c && d) { if ("function" != typeof a.compose) throw Error(b + "compose must be a function."); if ("function" != typeof a.decompose) throw Error(b + "decompose must be a function."); return true }
...
Blockly.InsertionMarkerManager.prototype.hideInsertionMarker_ = function() {
    if (this.markerConnection_) {
        ...
        !(a != c || d && d.targetConnection) || e ? a.targetBlock().unplug(!1) : a.type == Blockly.NEXT_STATEMENT && a != c ? (c = a.targetConnection, c.getSourceBlock().unplug(!1), d = d ? d.targetConnection : null, b.unplug(true), d && d.connect(c)) : b.unplug(true);
...
Blockly.InsertionMarkerManager.prototype.showInsertionInputOutline_ = function() {
    ...
    this.highlightedBlock_.highlightShapeForInput(a, true)
};
...
Blockly.BlockDragger.prototype.startBlockDrag = function(a, b) {
    Blockly.Events.getGroup() || Blockly.Events.setGroup(true);
...
Blockly.BlockDragger.prototype.maybeDeleteBlock_ = function() {
    ...
    this.wouldDeleteBlock_ ? (a && setTimeout(a.close.bind(a), 100), this.fireMoveEvent_(), this.draggingBlock_.dispose(!1, true), Blockly.draggingConnections = []) : a && a.close();
    return this.wouldDeleteBlock_
};
Blockly.BlockDragger.prototype.updateCursorDuringBlockDrag_ = function() {
    this.wouldDeleteBlock_ = this.draggedConnectionManager_.wouldDeleteBlock();
    var a = this.workspace_.trashcan;
    this.wouldDeleteBlock_ ? (this.draggingBlock_.setDeleteStyle(true), this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen(true)) : (this.draggingBlock_.setDeleteStyle(!1), a && a.setOpen(!1))
};
...
Blockly.VariableMap.prototype.deleteVariableInternal = function(a, b) {
    ...
    c || Blockly.Events.setGroup(true);
    try {
        for (var d = 0; d < b.length; d++) b[d].dispose(true);
...
Blockly.VariableMap.prototype.getVariableTypes = function(a) {
    ...
    a = Object.keys(b);
    b = !1;
    for (var c = 0; c < a.length; c++) "" == a[c] && (b = true);
    b || a.push("");
    return a
};
...
Blockly.Workspace.prototype.getAllBlocks = function(a) {
    if (a) { a = this.getTopBlocks(true); for (var b = [], c = 0; c < a.length; c++) b.push.apply(b, a[c].getDescendants(true)) } else
...
Blockly.Workspace.prototype.clear = function() {
    ...
    try {
        ...
        for (a || Blockly.Events.setGroup(true); this.topBlocks_.length;) this.topBlocks_[0].dispose(!1);
...
Blockly.Workspace.prototype.isCapacityAvailable = function(a) {
    ...
    return b > this.remainingCapacity() ? !1 : true
};
...
Blockly.Workspace.prototype.undo = function(a) {
    ...
    if (d) {
        ...
        try { for (b = 0; d = e[b]; b++) d.run(a) } finally { Blockly.Events.recordUndo = true }
    }
};
...
Blockly.Bubble.prototype.promote = function() { var a = this.bubbleGroup_.parentNode; return a.lastChild !== this.bubbleGroup_ ? (a.appendChild(this.bubbleGroup_), true) : !1 };
...
Blockly.BubbleDragger.prototype.maybeDeleteBubble_ = function() {
    var a = this.workspace_.trashcan;
    this.wouldDeleteBubble_ ? (a && setTimeout(a.close.bind(a), 100), this.fireMoveEvent_(), this.draggingBubble_.dispose(!1, true)) : a && a.close();
...
Blockly.BubbleDragger.prototype.updateCursorDuringBubbleDrag_ = function() {
    ...
    var a = this.workspace_.trashcan;
    this.wouldDeleteBubble_ ? (this.draggingBubble_.setDeleteStyle(true), this.deleteArea_ == Blockly.DELETE_AREA_TRASH && a && a.setOpen(true)) : (this.draggingBubble_.setDeleteStyle(!1), a && a.setOpen(!1))
};
...
Blockly.navigation.focusFlyout_ = function() {
    ...
    a && a.getWorkspace() && (a = a.getWorkspace().getTopBlocks(true), 0 < a.length && (a = a[0], a = Blockly.ASTNode.createStackNode(a), Blockly.navigation.getFlyoutCursor_().setCurNode(a)))
};
...
Blockly.navigation.insertFromFlyout = function() {
    ...
    if (b && b.isVisible()) {
        ...
        c.isEnabled() ? (b = b.createBlock(c), b.render(), b.setConnectionTracking(true), a.getCursor().setCurNode(Blockly.ASTNode.createBlockNode(b)), Blockly.navigation.modify_() || Blockly.navigation.warn_("Something went wrong while inserting a block from the flyout."), Blockly.navigation.focusWorkspace_(), a.getCursor().setCurNode(Blockly.navigation.getTopNode(b)),
...
Blockly.navigation.moveAndConnect_ = function(a, b) { if (!a || !b) return !1; var c = a.getSourceBlock(); return b.canConnectWithReason(a) == Blockly.Connection.CAN_CONNECT ? (Blockly.navigation.disconnectChild_(a, b), b.isSuperior() || c.getRootBlock().positionNearConnection(a, b), b.connect(a), true) : !1 };
...
Blockly.navigation.connect_ = function(a, b) {
    ...
    if (c && d && Blockly.navigation.moveAndConnect_(c, d) || e && f && Blockly.navigation.moveAndConnect_(e, f) || Blockly.navigation.moveAndConnect_(a, b)) return true;
...
Blockly.navigation.insertBlock = function(a, b) {
    switch (b.type) {
        case Blockly.PREVIOUS_STATEMENT:
            if (Blockly.navigation.connect_(a.nextConnection, b)) return true;
            break;
        case Blockly.NEXT_STATEMENT:
            if (Blockly.navigation.connect_(a.previousConnection, b)) return true;
            break;
        case Blockly.INPUT_VALUE:
            if (Blockly.navigation.connect_(a.outputConnection, b)) return true;
            break;
        case Blockly.OUTPUT_VALUE:
            ...
            if (a.outputConnection && Blockly.navigation.connect_(a.outputConnection, b)) return true
    }
...
Blockly.navigation.enableKeyboardAccessibility = function() { Blockly.getMainWorkspace().keyboardAccessibilityMode || (Blockly.getMainWorkspace().keyboardAccessibilityMode = true, Blockly.navigation.focusWorkspace_()) };
...
Blockly.navigation.onBlocklyAction = function(a) {
    var b = Blockly.getMainWorkspace().options.readOnly,
        c = !1;
    Blockly.getMainWorkspace().keyboardAccessibilityMode ? b ? -1 < Blockly.navigation.READONLY_ACTION_LIST.indexOf(a) && (c = Blockly.navigation.handleActions_(a)) : c = Blockly.navigation.handleActions_(a) : a.name === Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV && (Blockly.navigation.enableKeyboardAccessibility(), c = true);
    return c
};
Blockly.navigation.handleActions_ = function(a) {
    return a.name == Blockly.navigation.actionNames.TOOLBOX || Blockly.navigation.currentState_ == Blockly.navigation.STATE_TOOLBOX ? Blockly.navigation.toolboxOnAction_(a) : a.name == Blockly.navigation.actionNames.TOGGLE_KEYBOARD_NAV ? (Blockly.navigation.disableKeyboardAccessibility(), true) : Blockly.navigation.currentState_ == Blockly.navigation.STATE_WS ? Blockly.navigation.workspaceOnAction_(a) : Blockly.navigation.currentState_ == Blockly.navigation.STATE_FLYOUT ? Blockly.navigation.flyoutOnAction_(a) :
        !1
};
Blockly.navigation.flyoutOnAction_ = function(a) {
    var b = Blockly.getMainWorkspace(),
        c = b.getToolbox();
    if ((b = c ? c.flyout_ : b.getFlyout()) && b.onBlocklyAction(a)) return true;
    switch (a.name) {
        case Blockly.navigation.actionNames.OUT:
            return Blockly.navigation.focusToolbox_(), true;
        case Blockly.navigation.actionNames.MARK:
            return Blockly.navigation.insertFromFlyout(), true;
        case Blockly.navigation.actionNames.EXIT:
            return Blockly.navigation.focusWorkspace_(), true;
        default:
            return !1
    }
};
Blockly.navigation.toolboxOnAction_ = function(a) {
    var b = Blockly.getMainWorkspace(),
        c = b.getToolbox();
    return c && c.onBlocklyAction(a) ? true : a.name === Blockly.navigation.actionNames.TOOLBOX ? (b.getToolbox() ? Blockly.navigation.focusToolbox_() : Blockly.navigation.focusFlyout_(), true) : a.name === Blockly.navigation.actionNames.IN ? (Blockly.navigation.focusFlyout_(), true) : a.name === Blockly.navigation.actionNames.EXIT ? (Blockly.navigation.focusWorkspace_(), true) : !1
};
...
Blockly.navigation.workspaceOnAction_ = function(a) {
    if (Blockly.getMainWorkspace().getCursor().onBlocklyAction(a)) return true;
    switch (a.name) {
        case Blockly.navigation.actionNames.INSERT:
            return Blockly.navigation.modify_(), true;
        case Blockly.navigation.actionNames.MARK:
            return Blockly.navigation.handleEnterForWS_(), true;
        case Blockly.navigation.actionNames.DISCONNECT:
            return Blockly.navigation.disconnectBlocks_(), true;
...
Blockly.Gesture.prototype.updateIsDraggingFromFlyout_ = function() {
    return this.targetBlock_ && this.flyout_.isBlockCreatable_(this.targetBlock_) ? !this.flyout_.isScrollable() || this.flyout_.isDragTowardWorkspace(this.currentDragDeltaXY_) ? (this.startWorkspace_ = this.flyout_.targetWorkspace_, this.startWorkspace_.updateScreenCalculationsIfScrolled(), Blockly.Events.getGroup() || Blockly.Events.setGroup(true), this.startBlock_ = null, this.targetBlock_ = this.flyout_.createBlock(this.targetBlock_), this.targetBlock_.select(), true) : !1 : !1
};
...
Blockly.Gesture.prototype.updateIsDraggingBlock_ = function() {
    ...
    this.flyout_ ? this.isDraggingBlock_ = this.updateIsDraggingFromFlyout_() : this.targetBlock_.isMovable() && (this.isDraggingBlock_ = true);
    return this.isDraggingBlock_ ? (this.startDraggingBlock_(), true) : !1
};
Blockly.Gesture.prototype.updateIsDraggingWorkspace_ = function() { if (this.flyout_ ? this.flyout_.isScrollable() : this.startWorkspace_ && this.startWorkspace_.isDraggable()) this.workspaceDragger_ = this.flyout_ ? new Blockly.FlyoutDragger(this.flyout_) : new Blockly.WorkspaceDragger(this.startWorkspace_), this.isDraggingWorkspace_ = true, this.workspaceDragger_.startDrag() };
...
Blockly.Gesture.prototype.handleUp = function(a) {
    this.updateFromEvent_(a);
    Blockly.longStop_();
    this.isEnding_ ? console.log("Trying to end a gesture recursively.") : (this.isEnding_ = true, this.isDraggingBubble_ ? this.bubbleDragger_.endBubbleDrag(a, this.currentDragDeltaXY_) : this.isDraggingBlock_ ? this.blockDragger_.endBlockDrag(a, this.currentDragDeltaXY_) : this.isDraggingWorkspace_ ? this.workspaceDragger_.endDrag(this.currentDragDeltaXY_) : this.isBubbleClick_() ? this.doBubbleClick_() : this.isFieldClick_() ? this.doFieldClick_() :
...
Blockly.Gesture.prototype.doBlockClick_ = function() {
    this.flyout_ && this.flyout_.autoClose ? this.targetBlock_.isEnabled() && (Blockly.Events.getGroup() || Blockly.Events.setGroup(true), this.flyout_.createBlock(this.targetBlock_).scheduleSnapAndBump()) : Blockly.Events.fire(new Blockly.Events.Ui(this.startBlock_, "click", void 0, void 0));
    this.bringBlockToFront_();
    Blockly.Events.setGroup(!1)
};
...
Blockly.Gesture.inProgress = function() {
    for (var a = Blockly.Workspace.getAll(), b = 0, c; c = a[b]; b++)
        if (c.currentGesture_) return true;
    return !1
};
...
Blockly.Block = function(a, b, c) {
    ...
    if (Blockly.Events.isEnabled()) {
        (a = Blockly.Events.getGroup()) || Blockly.Events.setGroup(true);
...
Blockly.Block.prototype.dispose = function(a) {
    if (this.workspace) {
        ...
        try {
            ...
            var d = this.getConnections_(true);
            b = 0;
            for (var e; e = d[b]; b++) e.dispose()
        } finally { Blockly.Events.enable(), this.disposed = true }
    }
};
...
Blockly.Block.prototype.isDuplicatable = function() { return this.workspace.hasBlockLimits() ? this.workspace.isCapacityAvailable(Blockly.utils.getBlockTypeCounts(this, true)) : true };
...
Blockly.Block.prototype.getMatchingConnection = function(a, b) {
    var c = this.getConnections_(true);
...
Blockly.Block.prototype.getInputsInline = function() {
    ...
    for (a = 1; a < this.inputList.length; a++)
        if (this.inputList[a - 1].type == Blockly.INPUT_VALUE && this.inputList[a].type == Blockly.DUMMY_INPUT) return true;
    return !1
};
...
Blockly.Block.prototype.jsonInit = function(a) {
    ...
    void 0 !== a.output && this.setOutput(true, a.output);
    void 0 !== a.outputShape && this.setOutputShape(a.outputShape);
    void 0 !== a.previousStatement && this.setPreviousStatement(true, a.previousStatement);
    void 0 !== a.nextStatement && this.setNextStatement(true, a.nextStatement);
    ...
    void 0 !== a.mutator && Blockly.Extensions.apply(a.mutator, this, true);
            ...
            do
                if (k = !1, "string" == typeof f) g = new Blockly.FieldLabel(f);
                    ...
                    case "input_dummy":
                        ...
                        break;
                    default:
                        g = Blockly.fieldRegistry.fromJson(f), !g && f.alt && (f = f.alt, k = true)
                }
            while (k);
...
Blockly.Menu.prototype.focus = function() {
    ...
    a && (a.focus({ preventScroll: true }), Blockly.utils.dom.addClass(a, "focused"))
};
...
Blockly.Menu.prototype.attachEvents_ = function() {
    var a = this.getElement();
    this.mouseOverHandler_ = Blockly.bindEventWithChecks_(a, "mouseover", this, this.handleMouseOver_, true);
    this.clickHandler_ = Blockly.bindEventWithChecks_(a, "click", this, this.handleClick_, true);
    this.mouseEnterHandler_ = Blockly.bindEventWithChecks_(a, "mouseenter", this, this.handleMouseEnter_, true);
    this.mouseLeaveHandler_ = Blockly.bindEventWithChecks_(a, "mouseleave", this, this.handleMouseLeave_, true);
...
Blockly.Menu.prototype.setHighlightedIndex = function(a) {
    ...
    b ? (b.setHighlighted(true), this.highlightedIndex_ = a) : -1 < this.highlightedIndex_ && (this.getHighlighted().setHighlighted(!1), this.highlightedIndex_ = -1);
...
Blockly.Menu.prototype.highlightHelper = function(a, b) {
    ...
    for (var d = 0; d <= c;) {
        ...
        if (e && this.canHighlightItem(e)) return this.setHighlightedIndex(b), true;
        d++;
        b = a.call(this, b, c)
    }
    return !1
...
Blockly.Menu.prototype.handleKeyEvent = function(a) { return 0 != this.getChildCount() && this.handleKeyEventInternal(a) ? (a.preventDefault(), a.stopPropagation(), true) : !1 };
Blockly.Menu.prototype.handleKeyEventInternal = function(a) {
    var b = this.getHighlighted();
    if (b && "function" == typeof b.handleKeyEvent && b.handleKeyEvent(a)) return true;
...
Blockly.MenuItem.prototype.setChecked = function(a) {
    if (this.checkable_) {
        ...
        b && this.isEnabled() && (a ? (Blockly.utils.dom.addClass(b, "goog-option-selected"), Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, true)) : (Blockly.utils.dom.removeClass(b, "goog-option-selected"), Blockly.utils.aria.setState(b, Blockly.utils.aria.State.SELECTED, !1)))
    }
};
...
Blockly.MenuItem.prototype.handleClick = function(a) { this.isEnabled() && (this.setHighlighted(true), this.performActionInternal()) };
...
Blockly.ContextMenu.commentDuplicateOption = function(a) { return { text: Blockly.Msg.DUPLICATE_COMMENT, enabled: true, callback: function() { Blockly.duplicate(a) } } };
...
Blockly.RenderedConnection.prototype.stopTrackingAll = function() {
    ...
    if (this.targetConnection)
        for (var a = this.targetBlock().getDescendants(!1), b = 0; b < a.length; b++) {
            for (var c = a[b], d = c.getConnections_(true), e = 0; e < d.length; e++) d[e].setTracking(!1);
            c = c.getIcons();
...
Blockly.Cursor.prototype.onBlocklyAction = function(a) {
    if (this.getCurNode() && this.getCurNode().getType() === Blockly.ASTNode.types.FIELD && this.getCurNode().getLocation().onBlocklyAction(a)) return true;
    switch (a.name) {
...
Blockly.BasicCursor.prototype.validNode_ = function(a) {
    var b = !1;
    a = a && a.getType();
    if (a == Blockly.ASTNode.types.OUTPUT || a == Blockly.ASTNode.types.INPUT || a == Blockly.ASTNode.types.FIELD || a == Blockly.ASTNode.types.NEXT || a == Blockly.ASTNode.types.PREVIOUS || a == Blockly.ASTNode.types.WORKSPACE) b = true;
    return b
};
...
Blockly.TabNavigateCursor.prototype.validNode_ = function(a) {
    var b = !1,
        c = a && a.getType();
    a && (a = a.getLocation(), c == Blockly.ASTNode.types.FIELD && a && a.isTabNavigable() && a.isClickable() && (b = true));
    return b
};
...
Blockly.BlockSvg.prototype.generateContextMenu = function() {
    ...
    if (!this.isInFlyout) {
        ...
        if (this.isMovable())
            if (this.collapsed_) this.workspace.options.collapse && (c = { enabled: true }, c.text = Blockly.Msg.EXPAND_BLOCK, c.callback =
                ...
                this.workspace.options.collapse && (c = { enabled: true }, c.text = Blockly.Msg.COLLAPSE_BLOCK, c.callback = function() { a.setCollapsed(true) }, b.push(c))
            }
...
Blockly.BlockSvg.prototype.setDragging = function(a) {
    if (a) {
        ...
        b.translate_ = "";
        b.skew_ = "";
        Blockly.draggingConnections = Blockly.draggingConnections.concat(this.getConnections_(true));
...
Blockly.BlockSvg.prototype.setInsertionMarker = function(a) { this.isInsertionMarker_ != a && (this.isInsertionMarker_ = a) && (this.setColour(this.workspace.getRenderer().getConstants().INSERTION_MARKER_COLOUR), this.pathObject.updateInsertionMarker(true)) };
...
Blockly.BlockSvg.prototype.setWarningText = function(a, b) {
    ...
    if (this.workspace.isDragging()) {
        ...
        b = !1;
        "string" == typeof a ? (this.warning || (this.warning = new Blockly.Warning(this), b = true), this.warning.setText(a, c)) : this.warning && !c ? (this.warning.dispose(), b = true) : this.warning && (b = this.warning.getText(), this.warning.setText("", c), (d =
...
Blockly.BlockSvg.prototype.addSelect = function() { this.pathObject.updateSelected(true) };
...
Blockly.BlockSvg.prototype.render = function(a) {
    ...
    !1 !== a && ((a = this.getParent()) ? a.render(true) : this.workspace.resizeContents());
    Blockly.utils.dom.stopTextWidthCache();
    this.updateMarkers_()
};
...
Blockly.blockRendering.startDebugger = function() { Blockly.blockRendering.useDebugger = true };
...
Blockly.TouchGesture.prototype.handleTouchStart = function(a) {
    ...
    2 == b.length && (this.startDistance_ = Blockly.utils.Coordinate.distance(this.cachedPoints_[b[0]], this.cachedPoints_[b[1]]), this.isMultiTouch_ = true, a.preventDefault())
};
...
Blockly.WorkspaceSvg.prototype.updateInverseScreenCTM = function() { this.inverseScreenCTMDirty_ = true };
...
Blockly.WorkspaceSvg.prototype.createDom = function(a) {
    ...
    this.isFlyout || (Blockly.bindEventWithChecks_(this.svgGroup_, "mousedown", this, this.onMouseDown_, !1, true), Blockly.bindEventWithChecks_(this.svgGroup_, "wheel", this, this.onMouseWheel_));
        ...
        if (!isNaN(e) && !isNaN(f)) {
            ...
            do {
                ...
                for (var h; h = g[c]; c++) {
                    ...
                    if (1 >= Math.abs(e - k.x) && 1 >= Math.abs(f - k.y)) { a = true; break }
                }
                if (!a) {
                    var l = b.getConnections_(!1);
                    c = 0;
                    for (var m; m = l[c]; c++)
                        if (m.closest(Blockly.SNAP_RADIUS, new Blockly.utils.Coordinate(e, f)).connection) { a = true; break }
                }
...
Blockly.WorkspaceSvg.prototype.cleanUp = function() {
    ...
    Blockly.Events.setGroup(true);
    for (var a = this.getTopBlocks(true), b = 0, c = 0, d; d = a[c]; c++)
        if (d.isMovable()) {
...
Blockly.WorkspaceSvg.prototype.showContextMenu = function(a) {
    ...
    function c() {
        ...
        var a = p.shift();
        a && (a.workspace ? (a.dispose(!1, true), setTimeout(c, 10)) : c());
        Blockly.Events.setGroup(!1)
    }
    if (!this.options.readOnly && !this.isFlyout) {
        var d = [],
            e = this.getTopBlocks(true),
        ...
        h.callback = this.undo.bind(this, true);
        d.push(h);
        ...
        if (this.options.collapse) {
            for (var k = h = !1, l = 0; l < e.length; l++)
                for (var m = e[l]; m;) m.isCollapsed() ? h = true : k = true, m = m.getNextBlock();
            var n = function(a) {
...
Blockly.WorkspaceSvg.prototype.setBrowserFocus = function() { document.activeElement && document.activeElement.blur(); try { this.getParentSvg().focus({ preventScroll: true }) } catch (a) { try { this.getParentSvg().parentNode.setActive() } catch (b) { this.getParentSvg().parentNode.focus({ preventScroll: true }) } } };
...
Blockly.inject.loadSounds_ = function(a, b) {
    ...
    d.push(Blockly.bindEventWithChecks_(document, "mousemove", null, a, true));
    d.push(Blockly.bindEventWithChecks_(document, "touchstart", null, a, true))
};
Blockly.Names = function(a, b) {
    this.variablePrefix_ = b || "";
    this.reservedDict_ = Object.create(null);
    if (a)
        for (a = a.split(","), b = 0; b < a.length; b++) this.reservedDict_[a[b]] = true;
    this.reset()
};
...
Blockly.Procedures.isNameUsed = function(a, b, c) {
    ...
    for (var d = 0; d < b.length; d++)
        if (b[d] != c && b[d].getProcedureDef) { var e = b[d].getProcedureDef(); if (Blockly.Names.equals(e[0], a)) return true }
    return !1
};
...
Blockly.Variables.allDeveloperVariables = function(a) {
    ...
    for (var b = Object.create(null), c = 0, d; d = a[c]; c++) {
        ...
        !e && d.getDeveloperVars && (e = d.getDeveloperVars, Blockly.Variables.ALL_DEVELOPER_VARS_WARNINGS_BY_BLOCK_TYPE_[d.type] || (console.warn("Function getDeveloperVars() deprecated. Use getDeveloperVariables() (block type '" + d.type + "')"), Blockly.Variables.ALL_DEVELOPER_VARS_WARNINGS_BY_BLOCK_TYPE_[d.type] = true));
        if (e)
            for (d = e(), e = 0; e < d.length; e++) b[d[e]] = true
    }
...
Blockly.Variables.generateUniqueNameFromOptions = function(a, b) {
    ...
    for (var c = Blockly.Variables.VAR_LETTER_OPTIONS, d = "", e = c.indexOf(a);;) {
        for (var f = !1, g = 0; g < b.length; g++)
            if (b[g].toLowerCase() == a) { f = true; break }
        if (!f) return a;
        e++;
        ...
        if (b.options.readOnly) Blockly.navigation.onKeyPress(a);
            ...
            if (a.keyCode == Blockly.utils.KeyCodes.ESC) Blockly.hideChaff(), Blockly.navigation.onBlocklyAction(Blockly.navigation.ACTION_EXIT);
                ...
                if (a.keyCode == Blockly.utils.KeyCodes.BACKSPACE || a.keyCode == Blockly.utils.KeyCodes.DELETE) {
                    ...
                    Blockly.selected && Blockly.selected.isDeletable() && (c = true)
                } else if (a.altKey || a.ctrlKey || a.metaKey) {
                    if (Blockly.Gesture.inProgress()) return;
                    Blockly.selected && Blockly.selected.isDeletable() && Blockly.selected.isMovable() && (a.keyCode == Blockly.utils.KeyCodes.C ? (Blockly.hideChaff(), Blockly.copy_(Blockly.selected)) : a.keyCode != Blockly.utils.KeyCodes.X || Blockly.selected.workspace.isFlyout || (Blockly.copy_(Blockly.selected), c = true));
                    a.keyCode == Blockly.utils.KeyCodes.V ? Blockly.clipboardXml_ && (a = Blockly.clipboardSource_,
                        a.isFlyout && (a = a.targetWorkspace), Blockly.clipboardTypeCounts_ && a.isCapacityAvailable(Blockly.clipboardTypeCounts_) && (Blockly.Events.setGroup(true), a.paste(Blockly.clipboardXml_), Blockly.Events.setGroup(!1))) : a.keyCode == Blockly.utils.KeyCodes.Z && (Blockly.hideChaff(), b.undo(a.shiftKey))
                }
            }
            c && !Blockly.selected.workspace.isFlyout && (Blockly.Events.setGroup(true), Blockly.hideChaff(), Blockly.selected.dispose(true, true), Blockly.Events.setGroup(!1))
        }
};
Blockly.copy_ = function(a) {
    if (a.isComment) var b = a.toXmlWithXY();
    else {
        b = Blockly.Xml.blockToDom(a, true);
    ...
    Blockly.clipboardTypeCounts_ = a.isComment ? null : Blockly.utils.getBlockTypeCounts(a, true)
};
    ...
    var g = !1,
        h = function(a) {
            ...
            for (var f = 0, h; h = a[f]; f++)
                if (!b || Blockly.Touch.shouldHandleEvent(h)) Blockly.Touch.setClientFromTouch(h), c ? d.call(c, h) : d(h), g = true
        },
        k = [];
...
Blockly.Warning.prototype.setText = function(a, b) { this.text_[b] != a && (a ? this.text_[b] = a : delete this.text_[b], this.isVisible() && (this.setVisible(!1), this.setVisible(true))) };
...
Blockly.Comment.prototype.createEditor_ = function() {
    ...
    this.onMouseUpWrapper_ = Blockly.bindEventWithChecks_(b, "mouseup", this, this.startEdit_, true, true);
...
Blockly.Flyout.prototype.createBlock = function(a) {
    ...
    if (Blockly.Events.isEnabled())
        for (Blockly.Events.setGroup(true), Blockly.Events.fire(new Blockly.Events.Create(b)), c = 0; c < a.length; c++) Blockly.Events.fire(new Blockly.Events.VarCreate(a[c]));
...
Blockly.Flyout.prototype.placeNewBlock_ = function(a) {
    ...
    var c = Blockly.Xml.blockToDom(a, true);
    b.setResizesEnabled(!1);
...
Blockly.HorizontalFlyout.prototype.layout_ = function(a, b) {
    ...
    for (var e = 0, f; f = a[e]; e++)
        if ("block" == f.type) {
            f = f.block;
            for (var g = f.getDescendants(!1), h = 0, k; k = g[h]; h++) k.isInFlyout = true;
            f.render();
            g = f.getSvgRoot();
            h = f.getHeightWidth();
...
Blockly.HorizontalFlyout.prototype.isDragTowardWorkspace = function(a) { a = Math.atan2(a.y, a.x) / Math.PI * 180; var b = this.dragAngleRange_; return a < 90 + b && a > 90 - b || a > -90 - b && a < -90 + b ? true : !1 };
...
Blockly.VerticalFlyout.prototype.isDragTowardWorkspace = function(a) { a = Math.atan2(a.y, a.x) / Math.PI * 180; var b = this.dragAngleRange_; return a < b && a > -b || a < -180 + b || a > 180 - b ? true : !1 };
...
Blockly.tree.BaseNode.prototype.addChildAt = function(a, b) {
    ...
    if (b = this.getElement())
        if (this.updateExpandIcon(), Blockly.utils.aria.setState(b, Blockly.utils.aria.State.EXPANDED, this.expanded_), this.expanded_) {
            ...
            d || (c ? c.updateExpandIcon() : (Blockly.utils.style.setElementShown(b, true), this.setExpanded(this.expanded_)))
        }
};
...
Blockly.tree.BaseNode.prototype.selectChild = function() { return this.hasChildren() ? (this.expanded_ ? this.getChildAt(0).select() : this.setExpanded(true), true) : !1 };
...
Blockly.tree.TreeControl = function(a, b) {
    ...
    this.selected_ = this.expanded_ = true;
...
Blockly.tree.TreeControl.prototype.setSelectedItem = function(a) {
    if (a != this.selectedItem_ && (!this.onBeforeSelected_ || this.onBeforeSelected_.call(this.toolbox_, a))) {
        ...
        (this.selectedItem_ = a) && a.setSelected(true);
...
Blockly.Toolbox.prototype.init = function() {
    ...
    Blockly.bindEventWithChecks_(this.HtmlDiv, "mousedown",
        this,
        function(a) {
            Blockly.utils.isRightButton(a) || a.target == this.HtmlDiv ? Blockly.hideChaff(!1) : Blockly.hideChaff(true);
            Blockly.Touch.clearTouchIdentifier()
        }, !1, true);
    ...
    for (var d = null, e = null, f = 0, g; g = a.childNodes[f]; f++)
        if (g.tagName) switch (g.tagName.toUpperCase()) {
            case "CATEGORY":
                ...
                "true" == g.getAttribute("expanded") ? (h.blocks.length && (d = h), h.setExpanded(true)) : h.setExpanded(!1);
                e = g;
                break;
            case "SEP":
...
Blockly.Toolbox.prototype.setColour_ = function(a, b, c) {
    ...
    if (null === a || "" === a) b.hexColour = "";
        ...
        var d = Number(a);
        isNaN(d) ? (d = Blockly.utils.colour.parse(a)) ? (b.hexColour = d, this.hasColours_ = true) : (b.hexColour = "", console.warn('Toolbox category "' + c + '" has unrecognized colour attribute: ' + a)) : (b.hexColour = Blockly.hueToHex(d), this.hasColours_ = true)
    }
};
...
Blockly.Trashcan = function(a) {
    ...
    if (!(0 >= this.workspace_.options.maxTrashcanContents)) {
        a = new Blockly.Options({ scrollbars: true, parentWorkspace: this.workspace_, rtl: this.workspace_.RTL, oneBasedIndex: this.workspace_.options.oneBasedIndex, renderer: this.workspace_.options.renderer, rendererOverrides: this.workspace_.options.rendererOverrides });
...
Blockly.Trashcan.prototype.mouseOver_ = function() { this.contents_.length && this.setOpen(true) };
...
Blockly.Trashcan.prototype.cleanBlockXML_ = function(a) {
    for (var b = a = a.cloneNode(true); b;) {
...
Blockly.Mutator.reconnect = function(a, b, c) {
    ...
    var d = a.targetBlock();
    return d && d != b || c.targetConnection == a ? !1 : (c.isConnected() && c.disconnect(), c.connect(a), true)
};
...
Blockly.FieldTextInput.prototype.doValueUpdate_ = function(a) {
    ...
    this.value_ = a;
    this.isBeingEdited_ || (this.isDirty_ = true)
};
...
Blockly.FieldTextInput.prototype.render_ = function() {
    ...
    if (this.isBeingEdited_) {
        ...
        this.isTextValid_ ? (Blockly.utils.dom.removeClass(a, "blocklyInvalidInput"), Blockly.utils.aria.setState(a, Blockly.utils.aria.State.INVALID, !1)) : (Blockly.utils.dom.addClass(a, "blocklyInvalidInput"), Blockly.utils.aria.setState(a, Blockly.utils.aria.State.INVALID, true))
    }
};
...
Blockly.FieldTextInput.prototype.onHtmlInputChange_ = function(a) {
    ...
    a !== this.htmlInput_.oldValue_ && (this.htmlInput_.oldValue_ = a, Blockly.Events.setGroup(true), a = this.getValueFromEditorText_(a), this.setValue(a), this.forceRerender(), this.resizeEditor_(), Blockly.Events.setGroup(!1))
};
...
Blockly.FieldTextInput.prototype.isTabNavigable = function() { return true };
...
Blockly.FieldAngle.prototype.dropdownCreate_ = function() {
    ...
    this.clickSurfaceWrapper_ = Blockly.bindEventWithChecks_(b, "click", this, this.onMouseMove_, true, true);
    this.moveSurfaceWrapper_ = Blockly.bindEventWithChecks_(b, "mousemove", this, this.onMouseMove_, true, true);
    return a
};
...
Blockly.FieldCheckbox.prototype.doClassValidation_ = function(a) { return true === a || "TRUE" === a ? "TRUE" : !1 === a || "FALSE" === a ? "FALSE" : null };
...
Blockly.FieldColour.prototype.onKeyDown_ = function(a) {
    var b = !1;
    if (a.keyCode === Blockly.utils.KeyCodes.UP) this.moveHighlightBy_(0, -1), b = true;
    else if (a.keyCode === Blockly.utils.KeyCodes.DOWN) this.moveHighlightBy_(0, 1), b = true;
    else if (a.keyCode === Blockly.utils.KeyCodes.LEFT) this.moveHighlightBy_(-1, 0), b = true;
    else if (a.keyCode === Blockly.utils.KeyCodes.RIGHT) this.moveHighlightBy_(1, 0), b = true;
...
Blockly.FieldColour.prototype.onBlocklyAction = function(a) { if (this.picker_) { if (a === Blockly.navigation.ACTION_PREVIOUS) return this.moveHighlightBy_(0, -1), true; if (a === Blockly.navigation.ACTION_NEXT) return this.moveHighlightBy_(0, 1), true; if (a === Blockly.navigation.ACTION_OUT) return this.moveHighlightBy_(-1, 0), true; if (a === Blockly.navigation.ACTION_IN) return this.moveHighlightBy_(1, 0), true } return Blockly.FieldColour.superClass_.onBlocklyAction.call(this, a) };
...
Blockly.FieldColour.prototype.onMouseEnter_ = function() { this.picker_.focus({ preventScroll: true }) };
...
Blockly.FieldColour.prototype.dropdownCreate_ = function() {
    ...
    Blockly.utils.aria.setState(e, Blockly.utils.aria.State.EXPANDED, true);
    ...
    this.onClickWrapper_ = Blockly.bindEventWithChecks_(e, "click", this, this.onClick_, true);
    this.onMouseMoveWrapper_ = Blockly.bindEventWithChecks_(e, "mousemove", this, this.onMouseMove_, true);
    this.onMouseEnterWrapper_ = Blockly.bindEventWithChecks_(e, "mouseenter", this, this.onMouseEnter_, true);
...
Blockly.FieldDropdown.prototype.trimOptions_ = function() {
    ...
    if (Array.isArray(a)) {
        for (var b = !1, c = 0; c < a.length; c++) { var d = a[c][0]; "string" == typeof d ? a[c][0] = Blockly.utils.replaceMessageReferences(d) : (null != d.alt && (a[c][0].alt = Blockly.utils.replaceMessageReferences(d.alt)), b = true) }
        if (!(b || 2 > a.length)) {
            b = [];
...
Blockly.FieldDropdown.prototype.doClassValidation_ = function(a) {
    for (var b = !1, c = this.getOptions(true), d = 0, e; e = c[d]; d++)
        if (e[1] == a) { b = true; break }
...
Blockly.FieldDropdown.validateOptions_ = function(a) {
    ...
    for (var b = !1, c = 0; c < a.length; ++c) {
        var d = a[c];
        Array.isArray(d) ? "string" != typeof d[1] ? (b = true, console.error("Invalid option[" + c + "]: Each FieldDropdown option id must be a string. Found " + d[1] + " in: ", d)) : d[0] && "string" != typeof d[0] && "string" != typeof d[0].src && (b = true, console.error("Invalid option[" +
            c + "]: Each FieldDropdown option must have a string label or image description. Found" + d[0] + " in: ", d)) : (b = true, console.error("Invalid option[" + c + "]: Each FieldDropdown option must be an array. Found: ", d))
    }
    if (b) throw TypeError("Found invalid FieldDropdown options.");
};
Blockly.FieldDropdown.prototype.onBlocklyAction = function(a) { if (this.menu_) { if (a === Blockly.navigation.ACTION_PREVIOUS) return this.menu_.highlightPrevious(), true; if (a === Blockly.navigation.ACTION_NEXT) return this.menu_.highlightNext(), true } return Blockly.FieldDropdown.superClass_.onBlocklyAction.call(this, a) };
...
Blockly.FieldMultilineInput.prototype.render_ = function() {
    ...
    this.updateSize_();
    this.isBeingEdited_ && (this.sourceBlock_.RTL ? setTimeout(this.resizeEditor_.bind(this), 0) : this.resizeEditor_(), a = this.htmlInput_, this.isTextValid_ ? (Blockly.utils.dom.removeClass(a, "blocklyInvalidInput"), Blockly.utils.aria.setState(a, Blockly.utils.aria.State.INVALID, !1)) : (Blockly.utils.dom.addClass(a, "blocklyInvalidInput"), Blockly.utils.aria.setState(a, Blockly.utils.aria.State.INVALID, true)))
};
...
Blockly.FieldVariable.prototype.setTypes_ = function(a, b) {
    ...
    else if (Array.isArray(a)) { for (var c = !1, d = 0; d < a.length; d++) a[d] == b && (c = true); if (!c) throw Error("Invalid default type '" + b + "' in the definition of a FieldVariable"); } else throw Error("'variableTypes' was not an array in the definition of a FieldVariable");
    this.defaultType_ = b;
...
Blockly.FieldVariable.prototype.referencesVariables = function() { return true };
...
Blockly.blockRendering.Row.prototype.startsWithElemSpacer = function() { return true };
Blockly.blockRendering.Row.prototype.endsWithElemSpacer = function() { return true };
...
Blockly.blockRendering.TopRow.prototype.hasRightSquareCorner = function(a) { return true };
...
Blockly.blockRendering.BottomRow.prototype.hasRightSquareCorner = function(a) { return true };
...
Blockly.blockRendering.RenderInfo.prototype.createRows_ = function() {
    ...
    this.isCollapsed && (a.hasJaggedEdge = true, a.elements.push(new Blockly.blockRendering.JaggedEdge(this.constants_)));
...
Blockly.blockRendering.RenderInfo.prototype.populateTopRow_ = function() {
    ...
    b ? (a = new Blockly.blockRendering.Hat(this.constants_), this.topRow.elements.push(a),
        this.topRow.capline = a.ascenderHeight) : a && (this.topRow.hasPreviousConnection = true, this.topRow.connection = new Blockly.blockRendering.PreviousConnection(this.constants_, this.block_.previousConnection), this.topRow.elements.push(this.topRow.connection));
...
Blockly.blockRendering.RenderInfo.prototype.addInput_ = function(a, b) {
    this.isInline && a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.InlineInput(this.constants_, a)), b.hasInlineInput = true) : a.type == Blockly.NEXT_STATEMENT ? (b.elements.push(new Blockly.blockRendering.StatementInput(this.constants_, a)), b.hasStatement = true) : a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.ExternalValueInput(this.constants_, a)), b.hasExternalInput = true) : a.type == Blockly.DUMMY_INPUT && (b.minHeight =
        Math.max(b.minHeight, a.getSourceBlock() && a.getSourceBlock().isShadow() ? this.constants_.DUMMY_INPUT_SHADOW_MIN_HEIGHT : this.constants_.DUMMY_INPUT_MIN_HEIGHT), b.hasDummyInput = true);
    null == b.align && (b.align = a.align)
};
Blockly.blockRendering.RenderInfo.prototype.shouldStartNewRow_ = function(a, b) { return b ? a.type == Blockly.NEXT_STATEMENT || b.type == Blockly.NEXT_STATEMENT ? true : a.type == Blockly.INPUT_VALUE || a.type == Blockly.DUMMY_INPUT ? !this.isInline : !1 : !1 };
...
Blockly.blockRendering.Renderer.prototype.shouldHighlightConnection = function(a) { return true };
...
Blockly.geras.RenderInfo.prototype.addInput_ = function(a, b) {
    this.isInline && a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.geras.InlineInput(this.constants_, a)), b.hasInlineInput = true) : a.type == Blockly.NEXT_STATEMENT ? (b.elements.push(new Blockly.geras.StatementInput(this.constants_, a)), b.hasStatement = true) : a.type == Blockly.INPUT_VALUE ? (b.elements.push(new Blockly.blockRendering.ExternalValueInput(this.constants_, a)), b.hasExternalInput = true) : a.type == Blockly.DUMMY_INPUT && (b.minHeight = Math.max(b.minHeight,
...
Blockly.geras.RenderInfo.prototype.addElemSpacing_ = function() {
    for (var a = !1, b = 0, c; c = this.rows[b]; b++) c.hasExternalInput && (a = true);
...
Blockly.zelos.ConstantProvider = function() {
    ...
    this.FIELD_DROPDOWN_SVG_ARROW = this.FIELD_DROPDOWN_COLOURED_DIV = this.FIELD_DROPDOWN_NO_BORDER_RECT_SHADOW = true;
    this.FIELD_DROPDOWN_SVG_ARROW_PADDING = this.FIELD_BORDER_RECT_X_PADDING;
    this.FIELD_COLOUR_FULL_BLOCK = this.FIELD_TEXTINPUT_BOX_SHADOW = true;
...
Blockly.zelos.ConstantProvider.prototype.makeHexagonal = function() {
    ...
    return {
        ...
        pathRightDown: function(b) { return a(b, !1, true) },
        pathRightUp: function(b) { return a(b, !1, true) }
    }
};
Blockly.zelos.ConstantProvider.prototype.makeRounded = function() {
    ...
    return {
        ...
        connectionOffsetX: function(a) { return -a },
        pathDown: function(b) { return a(b, !1, !1) },
        pathUp: function(b) { return a(b, true, !1) },
        pathRightDown: function(b) { return a(b, !1, true) },
        pathRightUp: function(b) { return a(b, !1, true) }
    }
};
...
Blockly.zelos.RenderInfo.prototype.shouldStartNewRow_ = function(a, b) { return b ? a.type == Blockly.NEXT_STATEMENT || b.type == Blockly.NEXT_STATEMENT ? true : a.type == Blockly.INPUT_VALUE || a.type == Blockly.DUMMY_INPUT ? !this.isInline || this.isMultiRow : !1 : !1 };
            ...
            if (e ? this.topRow.hasPreviousConnection : b.followsStatement) {
                ...
                if (!e && g) b.height -= this.constants_.SMALL_PADDING,
                    ...
                    for (f = 0; g = c.elements[f]; f++)
                        if (Blockly.blockRendering.Types.isInlineInput(g) && g.connectedBlock && !g.connectedBlock.isShadow() && 40 <= g.connectedBlock.getHeightWidth().height) { e = true; break }
...
Blockly.zelos.PathObject.prototype.updateSelected = function(a) {
    ...
    a ? this.svgPathSelected_ || (this.svgPathSelected_ = this.svgPath.cloneNode(true), this.svgPathSelected_.setAttribute("fill", "none"), this.svgPathSelected_.setAttribute("filter", "url(#" + this.constants.selectedGlowFilterId + ")"), this.svgRoot.appendChild(this.svgPathSelected_)) : this.svgPathSelected_ && (this.svgRoot.removeChild(this.svgPathSelected_), this.svgPathSelected_ = null)
};
...
Blockly.zelos.MarkerSvg.prototype.showAtLocation_ = function(a) {
    var b = !1;
    a.getType() == Blockly.ASTNode.types.OUTPUT ? (this.showWithInput_(a), b = true) : a.getType() == Blockly.ASTNode.types.BLOCK && (this.showWithBlock_(a), b = true);
